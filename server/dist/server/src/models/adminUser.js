...
exports.initializeGodModeUser = initializeGodModeUser;
...
async function initializeGodModeUser() {
    try {
        const existingGodUser = await exports.AdminUser.findOne({ role: 'god' });
        if (!existingGodUser) {
            await exports.AdminUser.create({
                username: 'GodMode',
